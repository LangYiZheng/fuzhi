...
#define SecureUtil_Clz  "com/guyu/android/utils/SecureUtil"

#define SecureUtil_getDeviceId_Method  "getDeviceId"
#define SecureUtil_getDeviceId_Param  "()Ljava/lang/String;"

#define SecureUtil_getRandomAESKey_Method  "getRandomAESKey"
#define SecureUtil_getRandomAESKey_Param  "()[B"

#define SecureUtil_getServerKey_Method  "getServerKey"
#define SecureUtil_getServerKey_Param  "()[B"
...
#define SecureUtil_getRSAPublicKEY_Method "getRSAPublicKEY"
#define SecureUtil_getRSAPublicKEY_Param "(Landroid/content/Context;)Ljava/lang/String;"

#define SecureUtil_getRSAPrivateKEY_Method "getRSAPrivateKEY"
#define SecureUtil_getRSAPrivateKEY_Param "(Landroid/content/Context;)Ljava/lang/String;"
