...
public class BackService extends Service {
     ...
     *            通知id
     */
    public void showNotification(final String strText, int notification_id) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            notification = new Notification.Builder(this)
                    ...
                    .setContentTitle(this.getString(R.string.BACKING_RUNING)).build();
        }else{
            notification = new Notification();
            notification.icon =R.drawable.icon;
            try {
                Method deprecatedMethod = notification.getClass().getMethod("setLatestEventInfo", Context.class, CharSequence.class, CharSequence.class, PendingIntent.class);
                deprecatedMethod.invoke(notification, this, this.getString(R.string.BACKING_RUNING),strText, null, contentIntent);
