...
//	private static final UUID SerialPortServiceClass_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(GisQueryApplication.BLUETOOTH_MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(GisQueryApplication.BLUETOOTH_MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(GisQueryApplication.BLUETOOTH_DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(GisQueryApplication.BLUETOOTH_MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(GisQueryApplication.BLUETOOTH_TOAST, "Unable to connect device");
        mHandler.sendMessage(msg);
    }
    ...
    void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(GisQueryApplication.BLUETOOTH_MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(GisQueryApplication.BLUETOOTH_TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                  ...
                  bytes = mmInStream.read(buffer);
                    ...
                    mHandler.sendMessage( mHandler.obtainMessage(GisQueryApplication.BLUETOOTH_MESSAGE_READ));
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(GisQueryApplication.BLUETOOTH_MESSAGE_WRITE, buffer.length, -1, buffer).sendToTarget();
            } catch (IOException e) {
            	e.printStackTrace();
            }
        }
