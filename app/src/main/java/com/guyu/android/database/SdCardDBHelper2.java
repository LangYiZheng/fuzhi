 ...
 * 数据库管理和维护类
 **/
public class SdCardDBHelper2 extends SQLiteOpenHelper {

	public static final String TAG = "SdCardDBHelper";
	/**
	 * 数据库名称
	 **/
	public static String DATABASE_NAME = "iGisQueryData.db";
	...
	private static SdCardDBHelper2 mDbHelper = null;
	 ...
	 *            上下文环境
	 **/
	public SdCardDBHelper2(Context context) {
		super(context, DATABASE_NAME, null, DATABASE_VERSION);
	}

	public static SdCardDBHelper2 getInstance(Context paramContext) {
		if (mDbHelper == null) {
			DatabaseContext dbContext = new DatabaseContext(paramContext);
			mDbHelper = new SdCardDBHelper2(dbContext);
		}
		return mDbHelper;
	}
	/**
