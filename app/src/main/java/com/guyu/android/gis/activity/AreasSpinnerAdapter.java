...
public class AreasSpinnerAdapter extends BaseAdapter {
	 ...
	 * @param hint String
	 */
	public AreasSpinnerAdapter(Activity context, String[] values, String hint) {
  ...
  public View getDropDownView(final int position, View convertView, ViewGroup parent) {
		...
		if (position == index)
			textView.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.spinner_dropdown_item_checked));
		else
			textView.setBackgroundColor(activity.getResources().getColor(R.color.light_app_background));
